	...
	*
	...
	//          double indexx[3],
		 ...
		 )
	   {
		 const double small = 0.000001;
		 int i, j, k, imax;
		 std::vector< std::vector<double> > scale(order+1,std::vector<double>(2) );
		 double sum, amax, dum;
	...
	*
	...
	//          double matinv[3][3]
		 )
	   {
		  ...
		  std::vector< std::vector<double> > lu(order+1, std::vector<double>(order+1) );
		  std::vector< std::vector<double> >  b(order+1,std::vector<double>(2) );
