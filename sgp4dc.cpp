...
void dsvbksb
     ...
     )
     {
        int jj,j,i;
        double s;
        std::vector< std::vector<double> > tmp(n,std::vector<double>(1,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
...
void findatwaatwb
   ...
   )
   {
     ...
     int timezone, dat ;
     int indobs = 7;
     std::vector< std::vector<double> > a(indobs,std::vector<double>(statesize,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > at(statesize,std::vector<double>(indobs,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > atwaacc(statesize,std::vector<double>(statesize,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > atwbacc(statesize,std::vector<double>(1,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
//double rad;
//rad = 180.0 / pi;
...
void leastsquares
   ...
   )
   {
     ...
     double rad;
     int indobs = 7;
     std::vector< std::vector<double> > tmmp(statesize,std::vector<double>(statesize,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > b(indobs,std::vector<double>(1,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > atw(statesize,std::vector<double>(indobs,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > u(statesize,std::vector<double>(indobs,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > w(indobs,std::vector<double>(1,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > wutatwb(indobs,std::vector<double>(1,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > ww(indobs,std::vector<double>(indobs,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > v(indobs,std::vector<double>(indobs,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > ut(indobs,std::vector<double>(statesize,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > vw(indobs,std::vector<double>(indobs,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > vwut(indobs,std::vector<double>(1,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
     std::vector< std::vector<double> > atwao(statesize,std::vector<double>(statesize,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
