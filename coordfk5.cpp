...
void iau76fk5_itrf_gcrf
     ...
     )
     {
       ...
       for (std::vector< std::vector<double> >::iterator it=trans.begin(); it != trans.end();++it)
            it->resize(3);
       std::vector< std::vector<double> > prec, st, stdot, pm, pmp, // nut(3,3),
              stp, nutp, precp, temp;
	   std::vector< std::vector<double> > nut(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
...
void iau76fk5all_itrf_gcrf
     ...
     )
     {
       ...
       double psia, wa, epsa, chia,
              trueeps, meaneps, omega, thetasa, omegaearth[3], omgxr[3], omgxomgxr[3],
              omgxv[3], tempvec1[3], tempvec[3]; //DEBUG: don't redefine parameters rpef[3], vpef[3], apef[3], 
       double cospsi, sinpsi, coseps, sineps,costrueeps, sintrueeps, deg2rad;
...
void iau76fk5_itrf_teme
     ...
     )
     {
       ...
       for (std::vector< std::vector<double> >::iterator it=trans.begin(); it != trans.end();++it)
            it->resize(3);
       std::vector< std::vector<double> > pm, //st(3,3), stdot(3,3), temp(3,3), tempmat(3,3),
              pmp, stp;
	   std::vector< std::vector<double> > st(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
	   std::vector< std::vector<double> > stdot(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
	   std::vector< std::vector<double> > temp(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
	   std::vector< std::vector<double> > tempmat(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
...
void teme_pef
     (
      ...
      {
        double gmst;
        std::vector< std::vector<double> > tmp; //tm(3,3),
		std::vector< std::vector<double> > tm(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
