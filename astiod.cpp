     ...
     )
{
  ...
  std::vector< std::vector<double> > lmatii(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
  std::vector< std::vector<double> > cmat(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
  std::vector< std::vector<double> > rhomat(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
  std::vector< std::vector<double> > lmati(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
  std::vector< std::vector<double> > rsmat(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
  std::vector< std::vector<double> > lir(3,std::vector<double>(3,0.0)); //DEBUG: updated the vector<vector<double>> constructor.
