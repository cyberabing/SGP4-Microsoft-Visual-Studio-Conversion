// AstTimeDLL.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"
#include "AstTimeDLL.h"
/*     ----------------------------------------------------------------
*
*                                asttime.cpp
*
...
void    days2mdhms
        ...
        )
   {
     ...
     hr   = (int) floor(temp);//DEBUG: added explicit casts to make conversion unambiguous.
     temp = (temp - hr) * 60.0;
     minute  = (int) floor(temp);//DEBUG: added explicit casts to make conversion unambiguous.
